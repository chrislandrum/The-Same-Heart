...
global $showSuperbgimage, $fromGallery, $taxonomy_name, $the_term, $post_terms, $isFullsizeGallery, $isPost, $isBlog, $shortname, $page_obj, $main_homepage, $_query_has_videos, $isFullsizeFlickr, $infiniteScroll;
