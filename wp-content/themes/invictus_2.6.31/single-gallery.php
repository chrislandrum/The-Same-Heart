...
<div id="single-page" class="clearfix left-sidebar">
		...
		<div id="primary">		
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<?php /*?>	<div class="clearfix entry-meta entry-meta-head">
				...
				<div id="content" role="main">
					...
					?>
						...
						<div class="entry-image">
							...
							<a href="<?php echo $showUrl; ?>" data-link="<?php echo get_permalink($post_id) ?>" class="scroll-link" style="display: block;" data-rel="prettyPhoto" title="<?php echo strip_tags(get_the_excerpt()); ?>">
								<img src="<?php  echo $imgUrl; ?>" class="fade-image<?php if( get_option_max('image_show_fade') != "true") { echo(" no-hover"); } ?>" alt="<?php strip_tags(the_title()); ?>" title="<?php strip_tags(the_title()); ?>" />
							</a>
				...
				if ( get_option_max('image_show_gallery_images') == "true" ){
					...
					<?php if ( have_posts() ){ // show posts if query found some ?>
						...
						<div id="relatedGalleryImages" class="entry-related-images portfolio-four-columns">
							<h3 class="related-title"><?php _e('More Stories...', MAX_SHORTNAME) ?></h3>
