				...
				<div id="content" role="main">
						...
						$meta[MAX_SHORTNAME.'_photo_item_type_value'] == "vimeo_embed" )
					{
						...
						<div class="entry-image">
							<a href="<?php echo $imgUrl_full; ?>" data-link="<?php echo get_permalink($post_id) ?>" class="scroll-link" style="display: block;" data-rel="prettyPhoto" title="<?php echo get_the_excerpt() ?>">
