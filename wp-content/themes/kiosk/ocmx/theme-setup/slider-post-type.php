...
function my_custom_init_slider() 
{
  ...
  $args = array(
    ...
    'query_var' => true,
    'rewrite' => true,
    'menu_icon' => get_stylesheet_directory_uri() . '/ocmx/images/slider-icon.png',
  ...
  register_post_type('slider',$args);
	...
	register_taxonomy( 'slider-category', 'slider', array( 'hierarchical' => true, 'label' => 'Categories', 'query_var' => true, 'rewrite' => true ) );  
}
...
function slider_updated_messages( $messages ) {
  ...
  $messages['slider'] = array(
    ...
    1 => sprintf( __('Slider Item updated. <a href="%s">View slider item</a>'), esc_url( get_permalink($post_ID) ) ),
