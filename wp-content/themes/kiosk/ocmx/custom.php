...
$obox_meta = array(
		"media" => array (
			...
			"effects" => array(__("None",'ocmx') => "0", __("Grey Scale",'ocmx') => "2", __("Negative",'ocmx') => "1", __("Brightness",'ocmx') => "3", __("Contrast",'ocmx') => "5", __("Gaussian Blur",'ocmx') => "8", __("Colorize",'ocmx') => "4")
		),	
		"video" => array (
