					...
					<td colspan="3">
						<?php if($metabox["input_type"] == "image") : ?>
							...
							<?php if($metabox["effects"]) :
								$effect = get_post_meta($postId,$metabox["name"]."_effect",true);  ?>
								<div class="clearfix">
									<label class="image-edit-item noeffect selectit" title="None">
										<a href="#"<?php if($effect == 0) : ?> class="active"<?php endif; ?>></a>
										<input <?php if($effect == 0) : ?> checked="checked"<?php endif; ?> type="radio" name="<?php echo "obox_".$metabox["name"]."_effect"; ?>" value="0" />
									</label>
									<label class="image-edit-item greyscale" title="Grey Scale">
										<a href="#"<?php if($effect == 2) : ?> class="active"<?php endif; ?>></a>
										<input <?php if($effect == 2) : ?> checked="checked"<?php endif; ?> type="radio" name="<?php echo "obox_".$metabox["name"]."_effect"; ?>" value="2" />
									</label>
									
									<label class="image-edit-item negative" title="Negative">
										<a href="#"<?php if($effect == 1) : ?> class="active"<?php endif; ?>></a>
										<input <?php if($effect == 1) : ?> checked="checked"<?php endif; ?> type="radio" name="<?php echo "obox_".$metabox["name"]."_effect"; ?>" value="1" />
									</label>
									
									<label class="image-edit-item brightness" title="Brighten">
										<a href="#"<?php if($effect == 3) : ?> class="active"<?php endif; ?>></a>
										<input <?php if($effect == 3) : ?> checked="checked"<?php endif; ?> type="radio" name="<?php echo "obox_".$metabox["name"]."_effect"; ?>" value="3" />
									</label>
									
									<label class="image-edit-item contrast" title="Contrast">
										<a href="#"<?php if($effect == 5) : ?> class="active"<?php endif; ?>></a>
										<input <?php if($effect == 5) : ?> checked="checked"<?php endif; ?> type="radio" name="<?php echo "obox_".$metabox["name"]."_effect"; ?>" value="5" />
									</label>
									
									<label class="image-edit-item blur" title="Blur">
										<a href="#"<?php if($effect == 8) : ?> class="active"<?php endif; ?>></a>
										<input <?php if($effect == 8) : ?> checked="checked"<?php endif; ?> type="radio" name="<?php echo "obox_".$metabox["name"]."_effect"; ?>" value="8" />
									</label>
									
									<label class="image-edit-item colorize" title="Colorize">
										<a href="#"<?php if($effect == 4) : ?> class="active"<?php endif; ?>></a>
										<input <?php if($effect == 4) : ?> checked="checked"<?php endif; ?> type="radio" name="<?php echo "obox_".$metabox["name"]."_effect"; ?>" value="4" />
									</label>
								</div>
							<?php endif; ?>
							<div class="clearfix">
								<?php if($metabox_value != "") :
									...
									<div class="obox_main_image">
										<img src="<?php echo get_template_directory_uri(); ?>/functions/timthumb.php?src=<?php echo $metabox_value; ?>&h=255&w=590&zc=1&q=100&f=<?php echo $effect; ?>" />
									</div>
								<?php endif; ?>
							</div>
