...
$i = 1;
get_header(); ?>
<h2 class="post-title"><?php echo $parentpage->post_title; ?> <span>/ <a href="<?php echo get_permalink($main_page->ID); ?>"><?php echo $main_page->post_title; ?></a> <?php echo $term->name; ?></span></h2>
