...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		<a href="<?php echo $imageFull[0] ?>" data-rel="prettyPhoto" data-link="<?php get_permalink($post_id) ?>" title="<?php echo htmlspecialchars(get_the_excerpt()) ?>">
			<img src="<?php echo $image[0] ?>" width="660" class="fade-image" alt="<?php echo htmlspecialchars(get_the_title()) ?>" />
		</a>
		</div>
		<br />
		<?php endif; ?>
