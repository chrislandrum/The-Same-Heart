	...
	function theme_add_scripts() {
  	...
  	$_img_string = 'full';
		...
		if (!is_admin()) {
			...
			wp_register_script('custom-script', get_template_directory_uri() .'/js/custom.js', array('jquery-ui-custom', 'modenizr', 'isotope', 'imagesloaded', 'jquery-livequery', 'supersubs',  'superfish', 'fitvids', 'easing', 'prettyphoto', 'iscroll', 'superbgimage', 'tipsy' ), '1.0', TRUE );
