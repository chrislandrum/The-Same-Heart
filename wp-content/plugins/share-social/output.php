...
function get_barbuilder($step) {
	...
	elseif($step == 3) {
		...
		if($ltype == 'bar2'){$settings .= '<style>#Share-bar{top: 28px !important;}</style>';}
								...
								jQuery(".connected").sortable({
									...
									jQuery("#socialsuse li").each(function(){
										if( jQuery(this).text() == "Facebook"){
											 jQuery("#Share-networks").append(\'<a id="xFacebook" href="http://www.facebook.com/sharer.php?u=http://cunjo.com&t=Cunjo, making a better web" class="Link-wrap"><div class="Facebook-share link"><small>Share on Facebook</small></div></a>\');
										}
										else if( jQuery(this).text() == "Twitter"){
											 jQuery("#Share-networks").append(\'<a id="xTwitter" href="http://twitter.com/home?status=http://cunjo.com" class="Link-wrap"><div class="Twitter-share link"><small>Share on Twitter</small></div></a>\');
										}
										else if( jQuery(this).text() == "Linkedin"){
											 jQuery("#Share-networks").append(\'<a id="xLinkedin" href="http://www.linkedin.com/shareArticle?mini=true&url=http://cunjo.com&title=Cunjo, making a better web&ro=false&summary=Cunjo, making a better web&source=" class="Link-wrap"><div class="Linkedin-share link"><small>Share on Linkedin</small></div></a>\');
										}
										else if( jQuery(this).text() == "Pinterest"){
											 jQuery("#Share-networks").append(\'<a id="xPinterest" href="http://pinterest.com/pin/create/button/?url=http://cunjo.com&media=http://cunjo.com/wp-content/themes/nubpage/inc/images/logo-head.png&description=Cunjo, making a better web" class="Link-wrap"><div class="Pinterest-share link"><small>Share on Pinterest</small></div></a>\');
										}
										else if( jQuery(this).text() == "Google"){
											 jQuery("#Share-networks").append(\'<a id="xGoogle" href="https://plus.google.com/share?url=http://cunjo.com" class="Link-wrap"><div class="Google-share link"><small>Share on Google+</small></div></a>\');
										}
										else if( jQuery(this).text() == "Digg"){
											 jQuery("#Share-networks").append(\'<a id="xDigg" href="http://digg.com/submit?phase=2&partner=[partner]&url=http://cunjo.com&title=Cunjo, making a better web" class="Link-wrap"><div class="Digg-share link"><small>Share on Digg</small></div></a>\');
										}
										else if( jQuery(this).text() == "Myspace"){
											 jQuery("#Share-networks").append(\'<a id="xMyspace" href="http://www.myspace.com/Modules/PostTo/Pages/?u=http://cunjo.com&t=Cunjo, making a better web&c=%20" class="Link-wrap"><div class="Myspace-share link"><small>Share on Myspace</small></div></a>\');
										} 
										else if( jQuery(this).text() == "Stumbleupon"){
											 jQuery("#Share-networks").append(\'<a id="xStumbleupon" href="http://www.stumbleupon.com/submit?url=http://cunjo.com&title=Cunjo, making a better web" class="Link-wrap"><div class="Stumbleupon-share link"><small>Share on Stumbleupon</small></div></a>\');
										} 
										else if( jQuery(this).text() == "Bebo"){
											 jQuery("#Share-networks").append(\'<a id="xBebo" href="http://bebo.com/c/share?Url=http://cunjo.com&Title=Cunjo, making a better web" class="Link-wrap"><div class="Bebo-share link"><small>Share on Bebo</small></div></a>\');
										} 
										else if( jQuery(this).text() == "Blogger"){
											 jQuery("#Share-networks").append(\'<a id="xBlogger" href="http://www.blogger.com/blog_this.pyra?t=&u=http://cunjo.com" class="Link-wrap"><div class="Blogger-share link"><small>Share on Blogger</small></div></a>\');
										}
										else if( jQuery(this).text() == "Delicious"){
											 jQuery("#Share-networks").append(\'<a id="xDelicious" href="http://del.icio.us/post?v=4&partner=[partner]&noui&url=http://cunjo.com&title=Cunjo, making a better web" class="Link-wrap"><div class="Delicious-share link"><small>Share on Delicious</small></div></a>\');
										} 
										else if( jQuery(this).text() == "Xing"){
											 jQuery("#Share-networks").append(\'<a id="xXing" href="https://www.xing.com/social_plugins/share?url=http://cunjo.com&wtmc=Cunjo, making a better web;&sc_p=xing-share" class="Link-wrap"><div class="Xing-share link"><small>Share on Xing</small></div></a>\');
										}
										else if( jQuery(this).text() == "Tumblr"){
											 jQuery("#Share-networks").append(\'<a id="xTumblr" href="http://www.tumblr.com/share?v=3&u=http://cunjo.com&t=Cunjo, making a better web" class="Link-wrap"><div class="Tumblr-share link"><small>Share on Tumblr</small></div></a>\');
										}
										else if( jQuery(this).text() == "Technorati"){
											 jQuery("#Share-networks").append(\'<a id="xTechnorati" href="http://technorati.com/faves?add=http://cunjo.com" class="Link-wrap"><div class="Technorati-share link"><small>Share on Technorati</small></div></a>\');
										}
										else if( jQuery(this).text() == "Reddit"){
											 jQuery("#Share-networks").append(\'<a id="xReddit" href="http://reddit.com/submit?url=http://cunjo.com&title=Cunjo, making a better web" class="Link-wrap"><div class="Reddit-share link"><small>Share on Reddit</small></div></a>\');
										} 
										else if( jQuery(this).text() == "Netlog"){
											 jQuery("#Share-networks").append(\'<a id="xNetlog" href="http://www.netlog.com/go/manage/blog/view=add&origin=external&title=Cunjo, making a better web&message=[message]&tags=Cunjo, making a better web&referer=http://cunjo.com" class="Link-wrap"><div class="Netlog-share link"><small>Share on Netlog</small></div></a>\');
										} 
										else if( jQuery(this).text() == "Identi"){
											 jQuery("#Share-networks").append(\'<a id="xIdenti" href="http://identi.ca/index.php? action=newnotice&status_textarea=Cunjo, making a better web-http://cunjo.com" class="Link-wrap"><div class="Identi-share link"><small>Share on Identi</small></div></a>\');
										}
										else if( jQuery(this).text() == "Friendfeed"){
											 jQuery("#Share-networks").append(\'<a id="xFriendfeed" href="http://www.friendfeed.com/share?url=http://cunjo.com&title=Cunjo, making a better web" class="Link-wrap"><div class="Friendfeed-share link"><small>Share on Friendfeed</small></div></a>\');
										}
										else if( jQuery(this).text() == "Evernote"){
											 jQuery("#Share-networks").append(\'<a id="xEvernote" href="http://www.evernote.com/clip.action?url=http://cunjo.com&title=Cunjo, making a better web" class="Link-wrap"><div class="Evernote-share link"><small>Share on Evernote</small></div></a>\');
										}  
										else if( jQuery(this).text() == "Diigo"){
											 jQuery("#Share-networks").append(\'<a id="xDiigo" href="http://www.diigo.com/post?url=http://cunjo.com&title=Cunjo, making a better web" class="Link-wrap"><div class="Diigo-share link"><small>Share on Diigo</small></div></a>\');
										} 
									});
			...
			if($shareLayout == 'simple') {
				...
				$javascript 		.= 'jQuery("#Share-bar #Share-networks a div.link").attr("style", "background-image: url(http://cunjo.com/!Share/imgs/"+ theme +"/sprite-'.$shareLayout.'-"+ iconz +".png) !important;");';
			}
			...
			$javascript 	.= '}';
			$javascript 	.= '});';
			if($ltype == 'bar1' || $ltype == 'bar2') {$widthval = 100; $sizetype = 'width'; $positiontype = 'left';}elseif($ltype == 'bar3' || $ltype == 'bar4') {$widthval = 50;$sizetype = 'height';$positiontype = 'top';}
			if($ltype == 'bar1' || $ltype == 'bar2' || $ltype == 'bar3' || $ltype == 'bar4') {
	...
	elseif($step == 4 || $step == 5) {
		...
		if($_SESSION['share']['ltype'] == 'bar1'){$layoutz = 'bottom_tab';}elseif($_SESSION['share']['ltype'] == 'bar2'){$layoutz = 'top_tab';}elseif($_SESSION['share']['ltype'] == 'bar3'){$layoutz = 'sideleft_tab';}elseif($_SESSION['share']['ltype'] == 'bar4'){$layoutz = 'sideright_tab';}
		$ShareBarSettings = array('layout' => $layoutz, 'color' => $_POST['theme'], 'width' => $_POST['width'], 'position' => $_POST['position'], 'icons' => $_POST['iconz'], 'showat' => $_POST['showat']);
...
function get_linebuilder($step) {
	...
	$settings .= '<h2 id="headerattention">Design your widget:</h2>';
			...
			$css = '<style>'.$csscode.'</style>';
			if($ltype == 'button1'){$shareLayout = 'simple';}
			$javascript .= '<script>jQuery(function() {
								jQuery(".connected").sortable({
									placeholder: "ui-state-highlight",
									connectWith: ".connected"
	...
	elseif($step == 3 || $step == 4) {
		if($_SESSION['share']['ltype'] == 'button1'){$layoutz = 'simple';}
		$ShareLineSettings = array('layout' => $layoutz, 'color' => $_POST['theme'], 'position' => $_POST['position'], 'icons' => $_POST['iconz'], 'showing' => $_POST['showing']);
...
function show_shareline($ShareLineSettings, $pid) {
	$shareID = get_option('shareID');
	...
	foreach($shareSocial as $social) {
		...
		{
		case "Facebook":
		  $sharelinks .= '<a id="xFacebook" href="http://www.facebook.com/sharer.php?u='.$url.'&t='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Facebook-share2 link"><small>Share on Facebook</small></div></a>';
		  break;
		case "Twitter":
		  $sharelinks .= '<a id="xTwitter" href="http://twitter.com/home?status='.$url.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Twitter-share2 link"><small>Share on Twitter</small></div></a>';
		  break;
		case "Linkedin":
		  $sharelinks .= '<a id="xLinkedin" href="http://www.linkedin.com/shareArticle?mini=true&url='.$url.'&title='.$title.'&ro=false&summary='.$description.'&source=" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Linkedin-share2 link"><small>Share on Linkedin</small></div></a>';
		  break;
		case "Pinterest":
		  $sharelinks .= '<a id="xPinterest" href="http://pinterest.com/pin/create/button/?url='.$url.'&media='.$oneimage.'&description='.$description.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Pinterest-share2 link"><small>Share on Pinterest</small></div></a>';
		  break;
		case "Google":
		  $sharelinks .= '<a id="xGoogle" href="https://plus.google.com/share?url='.$url.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Google-share2 link"><small>Share on Google+</small></div></a>';
		  break;
		case "Digg":
		  $sharelinks .= '<a id="xDigg" href="http://digg.com/submit?phase=2&partner=[partner]&url='.$url.'&title='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Digg-share2 link"><small>Share on Digg</small></div></a>';
		  break;
		case "Myspace":
		  $sharelinks .= '<a id="xMyspace" href="http://www.myspace.com/Modules/PostTo/Pages/?u='.$url.'&t='.$title.'&c=%20" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Myspace-share2 link"><small>Share on Myspace</small></div></a>';
		  break; 
		case "Stumbleupon":
		  $sharelinks .= '<a id="xStumbleupon" href="http://www.stumbleupon.com/submit?url='.$url.'&title='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Stumbleupon-share2 link"><small>Share on Stumbleupon</small></div></a>';
		  break;  
		case "Bebo":
		  $sharelinks .= '<a id="xBebo" href="http://bebo.com/c/share?Url='.$url.'&Title='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Bebo-share2 link"><small>Share on Bebo</small></div></a>';
		  break; 
		case "Blogger":
		  $sharelinks .= '<a id="xBlogger" href="http://www.blogger.com/blog_this.pyra?t=&u='.$url.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Blogger-share2 link"><small>Share on Blogger</small></div></a>';
		  break;
		case "Delicious":
		  $sharelinks .= '<a id="xDelicious" href="http://del.icio.us/post?v=4&partner=[partner]&noui&url='.$url.'&title='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Delicious-share2 link"><small>Share on Delicious</small></div></a>';
		  break; 
		case "Xing":
		  $sharelinks .= '<a id="xXing" href="https://www.xing.com/social_plugins/share?url='.$url.'&wtmc='.$title.';&sc_p=xing-share" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Xing-share2 link"><small>Share on Xing</small></div></a>';
		  break;
		case "Tumblr":
		  $sharelinks .= '<a id="xTumblr" href="http://www.tumblr.com/share?v=3&u='.$url.'&t='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Tumblr-share2 link"><small>Share on Tumblr</small></div></a>';
		  break;
		case "Technorati":
		  $sharelinks .= '<a id="xTechnorati" href="http://technorati.com/faves?add='.$url.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Technorati-share2 link"><small>Share on Technorati</small></div></a>';
		  break;
		case "Reddit":
		  $sharelinks .= '<a id="xReddit" href="http://reddit.com/submit?url='.$url.'&title='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Reddit-share2 link"><small>Share on Reddit</small></div></a>';
		  break; 
		case "Netlog":
		  $sharelinks .= '<a id="xNetlog" href="http://www.netlog.com/go/manage/blog/view=add&origin=external&title='.$title.'&message=[message]&tags='.$description.'&referer='.$url.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Netlog-share2 link"><small>Share on Netlog</small></div></a>';
		  break; 
		case "Identi":
		  $sharelinks .= '<a id="xIdenti" href="http://identi.ca/index.php? action=newnotice&status_textarea='.$title.'-'.$url.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Identi-share2 link"><small>Share on Identi</small></div></a>';
		  break;
		case "Friendfeed":
		  $sharelinks .= '<a id="xFriendfeed" href="http://www.friendfeed.com/share?url='.$url.'&title='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Friendfeed-share2 link"><small>Share on Friendfeed</small></div></a>';
		  break;
		case "Evernote":
		  $sharelinks .= '<a id="xEvernote" href="http://www.evernote.com/clip.action?url='.$url.'&title='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Evernote-share2 link"><small>Share on Evernote</small></div></a>';
		  break;  
		case "Diigo":
		  $sharelinks .= '<a id="xDiigo" href="http://www.diigo.com/post?url='.$url.'&title='.$title.'" class="Link-wrap2" onclick="window.open(this.getAttribute(\'href\'),\'windowNew\',\'width=550,height=350,location=no,menubar=no,status=no,toolbar=no\'); return false"><div class="Diigo-share2 link"><small>Share on Diigo</small></div></a>';
		  break;  
		default:
		  $sharelinks .= '';
		}
	...
	$out .= '<style>';
		...
		$out .= '#Share-networks2 a div.link:hover small, #Share-logo-wrap2 div:hover small { z-index: 9999; display:block; position:absolute; bottom: 29px; margin:10px; z-index:9999; -moz-animation:mymove .25s linear;  -webkit-animation:mymove .25s linear; }';
		if(isset($icons) && $icons != ''){$shareLayouticons = $shareLayout.'-'.$icons; $linksborder = '';}else{$shareLayouticons = $shareLayout; $linksborder = 'border-bottom: 1px solid rgba(0,0,0,0.2); -webkit-box-shadow: inset 0px -1px 0px 0px rgba(255, 255, 255, 0.2); box-shadow: inset 0px -1px 0px 0px rgba(255, 255, 255, 0.2);';}
		if($shareColor == '24'){
			$out 	.= '#Share-bar2 {position: relative; height: 29px;}';
			$out 	.= '.Share-logo2 {display: inline-block; width: 28px; height: 29px; background-image: url(http://cunjo.com/!Share/icns/'.$shareLayouticons.'-'.$shareColor.'.png); background-repeat: no-repeat; background-position: -588px 0;}';
			$out 	.= '#Share-logo-wrap2 {display: inline-block; vertical-align: middle; width: 28px; height: 29px;}';
			$out 	.= '.Link-wrap2 {position: relative; display: inline-block; vertical-align: middle; width: 28px; height: 29px;}';
			$out 	.= '#Share-networks2 a div.link {display: block; width: 28px; height: 29px; background-image: url(http://cunjo.com/!Share/icns/'.$shareLayouticons.'-'.$shareColor.'.png); background-repeat: no-repeat;}';
		}
		else {
			$out 	.= '#Share-bar2 {position: relative; height: 42px;}';
			$out 	.= '.Share-logo2 {display: inline-block; width: 40px; height: 42px; background-image: url(http://cunjo.com/!Share/icns/'.$shareLayouticons.'-'.$shareColor.'.png); background-repeat: no-repeat; background-position: -830px 0;}';
			$out 	.= '#Share-logo-wrap2 {display: inline-block; vertical-align: middle; width: 40px; height: 42px;}';
			$out 	.= '.Link-wrap2 {position: relative; display: inline-block; vertical-align: middle; width: 40px; height: 42px;}';
			$out 	.= '#Share-networks2 a div.link {display: block; width: 40px; height: 42px; background-image: url(http://cunjo.com/!Share/icns/'.$shareLayouticons.'-'.$shareColor.'.png); background-repeat: no-repeat;}';
		}
		$out 	.= '#showShare2 {display: none;}';
		$out 	.= '#Share-logo-wrap2:hover {opacity: 0.8;}';
		$out 	.= '#Share-networks2 {position: relative; display: inline-block; vertical-align: middle;}';
		$out 	.= '.Link-wrap2:hover {opacity: 0.8;}';
		$out 	.= '#hideShare2 {display:none;}';
		$out 	.= '#Share-networks2:hover .socialgal {display: block;}';
		if($shareColor == '24'){
	...
	$out .= '</style>';
	if($shareLayout == "simple") {
		$out .= '<div id="Share-bar2" class="'.$shade.'"><div id="Share-networks2"><a href="http://cunjo.com/share/" target="_blank" id="Share-logo-wrap2" class="tip"><div class="Share-logo2"><small>Get this FREE Widget</small></div></a>'.$sharelinks.'</div></div>';
	}
	return $out;
}
function curPageURL() {
